...
public:
	...
	// set's the name and the certificate for a server with a self-signed certificate.
	void setPeer( const QString& peerName, const QSslCertificate& peerCertificate );
...
protected:
	...
	// the peer-certificate and -name are used for mail-server with a self-signed certifcate.
